...
local on_attach = function()
    ...
    vim.keymap.set('n', 'sd', ':FzfLua lsp_definitions<cr>')
    vim.keymap.set('n', 'si', ':FzfLua lsp_implementations<cr>')
    vim.keymap.set('n', 'sr', ':FzfLua lsp_references<cr>')
    vim.keymap.set('n', 'ss', ':FzfLua lsp_document_symbols<cr>')
